function Result(props) {
  let style = { borderColor: "", boxShadow: "" };
  let compStyle = { borderColor: "", boxShadow: "" };
  ...
  if (props.answer === "rock") {
    style.borderColor = "hsl(349, 71%, 52%)";
  } else if (props.answer === "scissors") {
    style.borderColor = "hsl(39, 89%, 49%)";
  } else if (props.answer === "paper") {
    style.borderColor = "hsl(230, 89%, 62%)";
  }

  if (props.randAnswer === "rock") {
    compStyle.borderColor = "hsl(349, 71%, 52%)";
  } else if (props.randAnswer === "scissors") {
    compStyle.borderColor = "hsl(39, 89%, 49%)";
  } else if (props.randAnswer === "paper") {
    compStyle.borderColor = "hsl(230, 89%, 62%)";
  }
  ...
  return (
    <div className="result-screen">
      <div className="user-answer">
        <p>You picked</p>
        <div style={style} className="answer-result">
          {(() => {
            switch (props.answer) {
              case "rock":
                return (
      ...
      <div className="play-again">
        <div className="game-result">{props.result}</div>
        <button className="play-again-btn" onClick={props.playAgain}>
          Play Again
        </button>
      </div>
      <div className="comp-answer">
        <p>The house picked</p>
        <div style={compStyle} className="answer-result">
          {(() => {
            switch (props.randAnswer) {
              case "rock":
                return (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
